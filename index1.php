    ...
    <div class="imgg">
            ...
            <ul id="navbar">
                ...
                <li class="nav-item" style="position:relative;bottom:-1px">
                            <a href="users/login.php" class="text-decoration-none"><img src="login2.png"  style="position:relative; bottom: 2px;"  height="23px" width="25px">Login</a>
                        </li>
            </ul>
        </div>
    </section>
...
<div class="container" style="padding-bottom: 100px;position:relative; bottom:20px">
    ...
    <section style="position:relative; bottom:130px">
        <div class="cont">
            <div class="row">
                <div class="splide">
                            ...
                            <div class="col-sm-12 col-md-2 splide__slide m-2">
                                <div class="card .bg-light .bg-dark">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title mt-2">sadwich</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-2 splide__slide m-2">
